---
layout: post
seo_title: Gas Line Installation. Which Pipes Are Better - Copper or Steel?
seo_description: "Planning to install gas fittings at your home? ✔️ Make sure to choose
  the right pipes. Which pipes are better for your pipeworks - copper \U0001F19A steel?"
main_keywords:
- pipeworks
...
title: Gas Line Installation. Which Pipes Are Better - Copper or Steel?
small-intro: Gas line installation has been an essential element for almost every
  new building over the recent years.
intro: Gas line installation has been an essential element for almost every new building
  over the recent years. It is quite benficial. It allows to connect the whole building
  with the heating system. Not every gas line installation is the same, which depends
  on the the materials used for its contruction. Typically, steel or copper pipes
  are used. They also need to be supplemented with other components such as valves
  and filters. Before you decide to choose a particular solution, learn the features
  of each of them. This way you will easily determine the best option for you.
photo: "/uploads/195e87ad8a354ffb801e5efc82cd9ffe.jpg"
photo_desc: Not every gas line installation is the same, which depends on the the
  materials used for its contruction.
faq:
- question: How to solder copper pipes?
  answer: If you are not a professional, do not attempt to solder a gas pipe. It is
    best to hire a specialist who can do it quickly and safely.
- question: How to connect PVC pipes?
  answer: You can connect a PVC tube by gluing it. Cover smoothed ends of both elements
    with glue, and then connect the two pieces. This is a very easy method of connecting
    a pvc pipe.
- question: How long do copper pipes last?
  answer: Copper pipes typically last around 20 years. If properly maintained, this
    type of pipework material can last up to 50 years - sometimes even longer.
- question: What are pvc pipes?
  answer: The abbreviation PVC stands for polyvinyl chloride. In recent times it has
    been common to replace metal pipes with PVC tubes in water installations.
...
_Steel pipes can be assembled by the means of soldering or using threaded fittings. Compared to copper pipes, the process of connecting steel pipes takes far more time. They are also less resistant to corrosion and more likely to build up scale inside (if used for a water installation). That's why steel pipes are chosen less frequently than copper tubes._

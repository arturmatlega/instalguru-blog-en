...
segmenting_tags: []
layout: post
seo_title: Screed - How To Lay A Durable and Resistant Concrete Floor?
seo_description: "Wanting to transform the looks of your house? \U0001F3E1 Planning
  a house renovation? \U0001F6E0️ Check how to choose the right type of screed."
date: 2020-12-14 23:00:00 +0000
update_date: 2020-12-14 23:00:00 +0000
title: What is screed and how to use it?
small-intro: Floor screed is referred to as one of the most important aspects of every
  construction investment.
intro: Floor screed is referred to as one the most important aspects of every construction
...
- question: What is screed?
  answer: 'Screed is nothing else than concrete floor. It can be used in basically
    every room, regardless of its purpose: house, basement, garage. Screed is usually
    laid before laying the floor.'
...
* **concrete screed** - typically containing Portland cement,
* **anhydrite screed** - made of natural or synthetic materials,
* **asphalt screed** - it's a mix several ingredients: asphalt, sand and crushed stone sand.
* **magnesite screed** - it uses caustic magnesite.

There are also other types of screed. Their classification looks as follows:
...
* firmly attach every element of the system,
* check the leaktightness of the system,
* fill the system with water before laying the screed.

## Screed - treatment and care after screeding

Proper care is an important aspect - especially in case of concrete screed, which cannot dry too quickly.
